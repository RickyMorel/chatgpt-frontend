class CssProperties {
    ...
    static MediumHeaderBoldTextStyle = {fontSize: '24px', fontFamily: "Work Sans", fontWeight: 900}
    static LargeHeaderBoldTextStyle = {fontSize: '32px', fontFamily: "Work Sans", fontWeight: 900}
}
