            ...
            <div className="col-2" style={colStyle}>
                {
                    ...
                    :
                    <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTbQLGnT0RH-Rh0_5NefuPRVbUAXU0CxPfpDw&s' className="img-fluid rounded" style={{ width: '55px', height: "100%" }} />
                }
            </div>
            <div className="col-8">
