    ...
    render() {
        ...
        <div className="row list-item z-depth-2 border">
            ...
            <div className="col s2">
                <a className={`waves-effect waves-light btn btn-small right ${isInDailyInventory == true ? Color.Second : Color.Fifth}`}>
                <i className="material-icons" onClick={() => handleClickCallback(item, isInDailyInventory)}>{isInDailyInventory == true ? "arrow_back" : "arrow_forward"}</i>
                </a>
            </div>
        </div>
        );
